          ...
          body: SafeArea(
            child: Padding(
              ...
              child: StreamBuilder<List<ProfilesRecord>>(
                stream: queryProfilesRecord(
                  queryBuilder: (profilesRecord) => profilesRecord.where('uid',
                ...
                builder: (context, snapshot) {
                  ...
                  List<ProfilesRecord> columnProfilesRecordList = snapshot.data;
                  // Return an empty Container when the document does not exist.
                  if (snapshot.data.isEmpty) {
                    return Container();
                  }
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller: textController1 ??=
                                      ...
                                      text: columnProfilesRecord.firstName,
                                    ),
                                    obscureText: false,
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller: textController3 ??=
                                        TextEditingController(
                                      text: columnProfilesRecord.phoneNumber,
                                    ),
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelText: 'Phone',
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller: textController6 ??=
                                        TextEditingController(
                                      text:
                                          columnProfilesRecord.propertyAddress1,
                                    ),
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelText: 'Address #1',
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller: textController7 ??=
                                        TextEditingController(
                                      text:
                                          columnProfilesRecord.propertyAddress2,
                                    ),
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelText: 'Address #2',
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller: textController8 ??=
                                        TextEditingController(
                                      text:
                                          columnProfilesRecord.propertyAddress3,
                                    ),
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelText: 'Address #3',
